...
const LANG = {
  en: {
    ...
    'gameCancelled': 'The game has started, please rejoin the game.',
  ...
  am: {
    ...
    'gameCancelled': 'ጨዋታ ተጀምሯል፣ እንደገና ይቀላቀሉ።',
...
async function displayReferralInfo() {
  ...
  if (data && data.referral_code) {
    const fullLink = `https://t.me/Nefbingo_bot?start=${data.referral_code}`;
